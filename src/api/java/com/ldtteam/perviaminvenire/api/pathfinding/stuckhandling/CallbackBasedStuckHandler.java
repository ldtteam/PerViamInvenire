...
public class CallbackBasedStuckHandler implements IStuckHandler
{
    /**
    ...
    /**
     * Callback that indicates if a entity can be stuck.
     */
    private Supplier<Boolean> canBeStuckCallback = () -> false;

    private Function<Block, Boolean> canBeBrokenIfStuck = (block) -> canBreakBlocks;

    private final Random rand = new Random();

    private CallbackBasedStuckHandler()
    {
    }
     ...
     */
    public static CallbackBasedStuckHandler create()
    {
        return new CallbackBasedStuckHandler();
    }
    ...
    private void completeStuckAction(final AbstractAdvancedGroundPathNavigator navigator)
    {
        ...
        {
            final Vector3i directionVector = new BlockPos(entity.getPositionVec()).subtract(navigator.getDesiredPos());
            final Direction facing = Direction.getFacingFromVector(directionVector.getX(), directionVector.getY(), directionVector.getZ());
    ...
    private void setAirIfPossible(final World world, final BlockPos pos)
    {
        ...
        if (!this.canBeBrokenIfStuck.apply(blockAtPos))
        {
            return;
        }
    ...
    private void placeLeaves(final AbstractAdvancedGroundPathNavigator navigator)
    {
        ...
        final Vector3i directionVector = new BlockPos(entity.getPositionVec()).subtract(navigator.getDesiredPos());
        final Direction badFacing = Direction.getFacingFromVector(directionVector.getX(), directionVector.getY(), directionVector.getZ()).getOpposite();
    ...
    public CallbackBasedStuckHandler withBlockBreaks()
    {
        canBreakBlocks = true;
        return this;
    }

    public CallbackBasedStuckHandler withPlaceLadders()
    {
        canPlaceLadders = true;
        return this;
    }

    public CallbackBasedStuckHandler withBuildLeafBridges()
    {
     ...
     * @return this
     */
    public CallbackBasedStuckHandler withTeleportSteps(int steps)
    {
        teleportRange = steps;
        return this;
    }

    public CallbackBasedStuckHandler withTeleportOnFullStuck()
    {
        canTeleportGoal = true;
        return this;
    }

    public CallbackBasedStuckHandler withTakeDamageOnStuck(float damagePct)
    {
     ...
     * @return this
     */
    public CallbackBasedStuckHandler withTimePerBlockDistance(int time)
    {
     ...
     * @return this
     */
    public CallbackBasedStuckHandler withDelayBeforeStuckActions(int delay)
    {
     ...
     * @return this
     */
    public CallbackBasedStuckHandler withCompleteStuckBlockBreak(int range)
    {
    ...
    /**
     * Sets the callback used to determine if the current entity can be stuck or not.
     *
     * @param canBeStuckCallback The callback. Returns true for entities which could be stuck, false when processing should be skipped.
     * @return this.
     */
    public CallbackBasedStuckHandler withCanBeStuckCallback(final Supplier<Boolean> canBeStuckCallback)
    {
        this.canBeStuckCallback = canBeStuckCallback;
        return this;
    }

    /**
     * Sets the callback used to determine if the current entity can break a given block or not.
     *
     * @param canBlockBeBrokenCallback The callback. Returns true for entities which can break the given block, false when not.
     * @return this.
     */
    public CallbackBasedStuckHandler withCanBlockBeBrokenCallback(final Function<Block, Boolean> canBlockBeBrokenCallback)
    {
        this.canBeBrokenIfStuck = canBlockBeBrokenCallback;
        return this;
    }
}