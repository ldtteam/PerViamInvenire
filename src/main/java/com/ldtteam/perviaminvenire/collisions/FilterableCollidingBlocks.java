...
public class FilterableCollidingBlocks extends AbstractIterator<CollidingBlock> {
   ...
   public FilterableCollidingBlocks(CollisionGetter collisionGetter, @Nullable Entity entity, AABB area, BiPredicate<BlockState, BlockPos> filter) {
   ...
   protected CollidingBlock computeNext() {
      while(true) {
         if (this.cursor.advance()) {
            ...
            if (collisionShape == Shapes.block()) {
               ...
               return new CollidingBlock(blockstate, this.pos.immutable());
            }
